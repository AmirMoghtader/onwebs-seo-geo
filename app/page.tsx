  ...
  return (
    <section className="h-full overflow-y-clip flex">
      ...
      <div className="w-full min-w-0">
        ...
        <div className="fixed top-0 left-0 right-0 z-[2000] h-11 border-b  bg-white dark:bg-brand-darker flex items-center px-4 dark:border-b-brand-dark">
          <MenuDrawer />
          {/* SEARCH STARTS HERE  */}
        ...
        {/* TABS SECTION */}
        <section className="mt-[31px] relative h-[calc(100vh-7.4rem)] overflow-hidden pt-0 px-0.5 pl-2 ">
          <Tabs defaultValue="first" className="h-full">
            <div className="transition-all   ease-in  bg-white duration-150 border-t dark:border-brand-dark  fixed left-0 right-0 pt-1 top-[42px]  transform dark:bg-brand-darker  pb-0 z-[999]">
              <Tabs.List
                justify="center"
