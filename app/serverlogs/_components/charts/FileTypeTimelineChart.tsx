      ...
      <div className="absolute top-2 right-4 flex items-center gap-2 z-10 transition-all duration-300">
        ...
        <Select value={timeRange} onValueChange={setTimeRange}>
          ...
          <SelectContent className="dark:bg-slate-950 dark:border-brand-dark">
            <SelectItem value="all" className="text-[9px]">کل زمان</SelectItem>
            <SelectItem value="7d" className="text-[9px]">۷ روز گذشته</SelectItem>
            <SelectItem value="30d" className="text-[9px]">۳۰ روز گذشته</SelectItem>
            <SelectItem value="90d" className="text-[9px]">۹۰ روز گذشته</SelectItem>
          </SelectContent>
        </Select>
      </div>
