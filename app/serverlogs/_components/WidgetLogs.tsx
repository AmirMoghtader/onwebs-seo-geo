...
export default function WidgetLogs() {
  ...
  // recharts derives clipPath ids from a module-level counter, so the ids the
  // server renders never match the client's and React flags the mismatch on
  // every load. Charts carry no information before hydration anyway — render
                ...
                <DialogContent className="max-w-11/12 w-11/12  dark:text-white dark:border-brand-bright dark:bg-brand-darker max-h-[90vh] overflow-hidden">
                  {activeTab === "Filetypes" ? (
                    ...
                    <Tabs defaultValue="logs" className="h-full">
                      <Tabs.List>
                        ...
                        <Tabs.Tab value="logs">URLها</Tabs.Tab>
                      </Tabs.List>
                  ...
                  activeTab === "User Agents" ? (
                    ...
                    <div className="flex flex-col h-full">
                      ...
                      >
                        <Tabs.List>
                          <Tabs.Tab value="overview">جدول فراوانی</Tabs.Tab>
                        </Tabs.List>
                        <Tabs.Panel value="overview" className="h-full">
                          {entry?.name === "Google" && (
