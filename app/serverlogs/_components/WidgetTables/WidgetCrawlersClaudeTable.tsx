  ...
  const exportCSV = async () => {
    ...
    try {
      const filePath = await save({
        defaultPath: `Onwebs SEO & GEO - Claude Bot Frequency -${new Date().toISOString().slice(0, 10)}.csv`,
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead className="text-center">بازدید ساعتی</TableHead>
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div className="flex flex-col max-w-[70rem] w-full">
                                  <div className="flex mb-2 space-x-2 items-center justify-between">
                                    <h4 className="font-bold">بازه زمانی</h4>
                                    {log.verified && (
