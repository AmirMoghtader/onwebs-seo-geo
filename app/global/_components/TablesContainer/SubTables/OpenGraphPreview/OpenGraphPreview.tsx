    ...
    return (
      <div className="text-base text-black/50 dark:text-white/50 flex justify-center items-center m-auto w-full h-full">
        <span className="text-xs">
          برای دیدن پیش‌نمایش OpenGraph، یک URL از جدول HTML انتخاب کنید
        </span>
      </div>
    );
  }
        ...
        <div className="flex-1 relative overflow-hidden">
          ...
          >
            <div className="w-full max-w-2xl h-full flex flex-col justify-center">
              {/* <h2 className="text-lg font-semibold mb-4 dark:text-white shrink-0">پیش‌نمایش Facebook / OpenGraph</h2> */}
                    ...
                    <img
                      ...
                      onError={(e) => {
                        ...
                        e.currentTarget.parentElement.innerHTML =
                          '<div class="flex items-center justify-center h-32 text-gray-400 dark:text-gray-600 text-sm">تصویر موجود نیست</div>';
                      }}
                    />
                  </div>
                )}
              ...
              <div className="bg-white dark:bg-brand-dark border border-gray-200 dark:border-gray-700 rounded-lg p-4 h-full overflow-scroll">
                {Object.keys(ogData).length > 0 ? (
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">
                    هیچ داده‌ی OpenGraph برای این URL پیدا نشد
                  </p>
                )}
              </div>
            </div>
