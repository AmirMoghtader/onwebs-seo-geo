...
import { useTableSort, sortIndicator, type SortState } from "../components/useTableSort";
...
const TableHeader = ({
  ...
  return useMemo(
    ...
    [visibleItems, onResize, onAlignToggle, onSort, sort],
  );
};
...
const TableRow = ({
  ...
  // comparator sees exactly the values rendered here.
...
const ImagesCrawlTable = ({
  ...
  const handleDownload = async () => {
    if (!rows.length) {
      toast.error("داده‌ای برای دانلود وجود ندارد، ابتدا یک کراول انجام دهید");
      return;
    }
