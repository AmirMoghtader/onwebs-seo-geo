    ...
    return (
      <div className="flex flex-col items-center justify-center h-full dark:text-gray-400 gap-4">
        ...
        <Text size="sm" className="font-medium">
          داده کراولی برای ساخت درخت موجود نیست.
        </Text>
      </div>
    );
  }
      ...
      <div className="flex-none px-3 py-2 border-b dark:border-brand-dark bg-gray-50/50 dark:bg-brand-dark/20 z-10">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <Tooltip label="کل صفحات" position="bottom" withArrow>
            ...
            <Tooltip label="کل پوشه‌ها" position="bottom" withArrow>
            ...
            <Tooltip label="حداکثر عمق" position="bottom" withArrow>
        ...
        <div className="flex items-center gap-1.5 mt-2">
          <TextInput
            size="xs"
            placeholder="فیلتر بر اساس مسیر یا URL..."
            value={search}
          ...
          <Tooltip label="باز کردن همه" position="bottom" withArrow>
            <ActionIcon
              size="sm"
              variant="subtle"
              color="gray"
          ...
          <Tooltip label="بستن همه" position="bottom" withArrow>
            <ActionIcon
              size="sm"
              variant="subtle"
              color="gray"
                  ...
                  {customNode.isPage && (
                    <div className="flex items-center gap-1 flex-none pr-1">
                      {customNode.indexable === false && (
                        <Tooltip label="غیرقابل ایندکس" position="top" withArrow>
