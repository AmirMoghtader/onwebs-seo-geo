      ...
      <div className="bg-white dark:bg-[#202124] border-x border-b border-gray-200 dark:border-white/5 rounded-b-2xl p-8 shadow-2xl transition-all duration-500 group-hover:shadow-blue-500/5">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col">
              ...
              <div className="flex items-center text-[12px] text-[#4d5156] dark:text-gray-400 mt-0.5">
                <span className="font-black mr-1 text-[10px] uppercase tracking-tighter text-blue-600 dark:text-blue-400">حمایت‌شده</span>
        ...
        <div className="mt-2">
          {currentHeadlines.length > 0 ? (
            ...
            <h3 className="text-[22px] text-gray-300 dark:text-gray-700 italic font-medium">[تیترهای خود را در فرم وارد کنید]</h3>
          )}
        </div>
        ...
        <div className="mt-2.5 text-[14px] text-[#4d5156] dark:text-[#bdc1c6] leading-[1.6] max-w-[620px] font-normal">
          {currentDescription ? (
            ...
            <p className="text-gray-300 dark:text-gray-700 italic">[توضیحات شما اینجا نمایش داده می‌شود]</p>
          )}
        </div>
        ...
        <div className="relative aspect-video bg-gray-900 flex items-center justify-center group cursor-pointer overflow-hidden">
          ...
          {ad.images && ad.images.length > 0 && (
            <img
              ...
              alt="تصویر بندانگشتی تبلیغ Youtube"
            />
          )}
          ...
          <div className="absolute bottom-6 right-0 bg-black/70 backdrop-blur-xl text-white py-3 px-6 border-l-[3px] border-amber-400 flex items-center gap-3 animate-in slide-in-from-right duration-1000">
            <span className="text-[10px] font-black uppercase tracking-widest opacity-60">رد شدن در</span>
        ...
        <div className="p-6 bg-white dark:bg-[#0f0f0f] flex items-start gap-4">
          <div className="w-12 h-12 rounded-full bg-gradient-to-br from-red-600 to-red-800 flex-shrink-0 flex items-center justify-center shadow-lg overflow-hidden">
            {ad.logos && ad.logos.length > 0 ? (
              <img src={ad.logos[0].url} className="w-full h-full object-cover" alt="لوگو" />
            ) : (
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex flex-col">
                    ...
                    <div className="flex items-center text-[10px] text-gray-400 font-bold uppercase tracking-widest mt-0.5">
                      <span className="text-blue-500">حمایت‌شده</span>
                    </div>
                  </div>
                </div>
        ...
        <div className="absolute inset-0 flex flex-col p-8">
          <div className="flex items-center gap-3 mb-auto">
            <div className="w-10 h-10 rounded-xl bg-white dark:bg-gray-800 shadow-xl flex items-center justify-center border border-gray-100 dark:border-white/5 overflow-hidden">
              {logoUrl ? (
                <img src={logoUrl} className="w-full h-full object-cover" alt="لوگو" />
              ) : (
