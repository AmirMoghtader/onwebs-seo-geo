    ...
    return (
      <div className="flex flex-col items-center justify-center py-12">
        <h3 className="text-lg font-medium dark:text-white/50">
          هنوز تبلیغی ساخته نشده
        </h3>
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
          برای شروع، اولین تبلیغ خود را بسازید
        </p>
      </div>
    );
  }
        ...
        <div className="flex items-center gap-2">
          <div className="relative">
            ...
            <input
              ...
              placeholder="جستجوی تبلیغات، کلمات کلیدی…"
          ...
          <select
            ...
            title="مرتب‌سازی تبلیغات"
          >
            <option value="recent">جدیدترین</option>
            <option value="strength">قدرت تبلیغ</option>
                  ...
                  <div>
                    ...
                    <div className="flex gap-3">
                      ...
                      <div className="flex flex-col">
                        ...
                        <span className="text-[9px] text-gray-500">توضیحات</span>
                      </div>
                      <div className="flex flex-col">
                        <span className="text-xs font-bold text-gray-900 dark:text-white">
                          {(ad.keywords || []).length}
