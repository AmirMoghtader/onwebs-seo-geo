    ...
    return (
      <div className="flex flex-col items-center justify-center h-full text-center">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1 max-w-sm">
          برای دسترسی به تحلیل مجموعه، امتیازدهی قدرت تبلیغ و بینش‌های بهینه‌سازی، اولین تبلیغ خود را بسازید.
        </p>
        {onCreate && (
          <button
            onClick={onCreate}
          ...
          >
            <Plus className="h-4 w-4" /> اولین تبلیغ خود را بسازید
          </button>
        )}
      </div>
    );
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5">
        ...
        <div className="lg:col-span-5 bg-white dark:bg-brand-darker/60 border border-gray-100 dark:border-white/5 rounded-2xl p-5 shadow-sm">
          ...
          <p className="text-[10px] text-gray-400 mb-4">
            امتیاز مجموعه تبلیغات شما در سطوح کیفی مختلف.
          </p>
          ...
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-[10px] text-gray-400 mt-0.5">
                ضعیف‌ترین تبلیغات شما — بزرگ‌ترین فرصت‌ها در ابتدا.
              </p>
            </div>
