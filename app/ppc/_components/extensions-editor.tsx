    ...
    return (
        <div className="space-y-4">
            <div className="flex items-center justify-between">
                <div>
                    <h4 className="text-sm font-bold text-gray-900 dark:text-white">Extensionهای تبلیغ</h4>
                    <p className="text-[10px] text-gray-500 dark:text-gray-400 uppercase tracking-widest font-black opacity-60">برای بهبود عملکرد تبلیغ، asset اضافه کنید</p>
                </div>
                <div className="flex gap-2">
                    ...
                    >
                        ...
                        <option value="promotion">تخفیف</option>
                    </select>
                    <button
                        type="button"
                        onClick={handleAdd}
                    ...
                    >
                        <Plus className="h-3.5 w-3.5" /> <span>افزودن</span>
                    </button>
                </div>
            </div>
            ...
            <div className="space-y-3">
                ...
                {extensions.length === 0 && (
                    <div className="flex flex-col items-center justify-center py-10 border-2 border-dashed border-gray-100 dark:border-white/5 rounded-2xl opacity-50 space-y-2">
                        ...
                        <p className="text-xs font-bold text-gray-500">هنوز Extensionی اضافه نشده</p>
                    </div>
                )}
            </div>
        </div>
