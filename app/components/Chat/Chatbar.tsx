  ...
  return (
    <div className="flex flex-1 flex-col items-center justify-center gap-3 bg-white px-6 text-center dark:bg-[#1a1a1a]">
      ...
      <p className="text-xs text-gray-600 dark:text-gray-300">
        Pick a display name to join the Onwebs SEO & GEO community chat.
      </p>
  ...
  useEffect(() => {
    ...
    const loadHistory = async () => {
      ...
      if (error) {
        ...
        toast.error("بارگذاری تاریخچه چت ناموفق بود");
      } else {
      ...
      >
        ...
        {showBlockedPanel && (
          ...
          >
            ...
            {blockedCount === 0 ? (
              <p className="text-xs text-gray-400">هیچ‌کس مسدود نشده است.</p>
            ) : (
