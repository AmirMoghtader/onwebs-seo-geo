  ...
  return (
    ...
    >
      ...
      <CardContent className="space-y-2 h-full">
        ...
        />
        <div>
          <h4 className="font-semibold mb-1 dark:text-white/50">ایده‌ها:</h4>
        ...
        />
        {/* <div className="flex items-center">
          <span className="mr-2">امتیاز:</span>
        ...
        >
          ...
          <SelectContent>
            ...
            <SelectItem value="Social Proof">اثبات اجتماعی</SelectItem>
          </SelectContent>
        </Select>
        <Select
          value={item.urgency}
        ...
        >
          <SelectTrigger className="w-full dark:text-white/50">
            <SelectValue placeholder="میزان فوریت را انتخاب کنید" />
          </SelectTrigger>
          <SelectContent>
            <SelectItem value="Priority">اولویت</SelectItem>
            <SelectItem value="Not Priority">بدون اولویت</SelectItem>
          </SelectContent>
        </Select>
        <Input
          value={item.assignee}
