    ...
    <div className="flex-1 flex flex-col sm:flex-row gap-4 items-center">
      <div className="h-[160px] w-[160px] relative shrink-0">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
          <span className="text-[9px] font-bold text-slate-400 uppercase tracking-widest">صفحات</span>
      ...
      <div className="flex-1 w-full min-w-0">
        ...
        <p className="text-[9px] font-bold uppercase tracking-wider text-slate-400 mb-1.5">
          مهم‌ترین دلایل مسدودسازی
        </p>
        <div className="space-y-1.5">
          {reasons.length === 0 && (
            <p className="text-[11px] text-slate-400">هیچ صفحه مسدود‌شده‌ای یافت نشد.</p>
          )}
          {reasons.map((r) => (
