    ...
    return (
      <div className="flex flex-col items-center justify-center h-[60vh] space-y-4">
        ...
        <p className="text-sm text-gray-500">
          در حال بررسی اتصال Google Analytics...
        </p>
      </div>
    );
  }
          ...
          {!isWizardOpen ? (
            ...
            >
              ...
              <p className="text-gray-500 dark:text-gray-400 mb-8 leading-relaxed">
                به بینش‌های قدرتمند درباره ترافیک وب‌سایت و رفتار کاربران دست پیدا کنید. Property خود در GA4 را متصل کنید تا sessionها، نرخ پرش و شاخص‌های تعامل را مستقیماً در Onwebs SEO & GEO ببینید.
              </p>
              <Button
