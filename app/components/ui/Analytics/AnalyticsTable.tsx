...
export default function AnalyticsTable() {
  ...
  const handleFilteredAnalytics = useCallback(
    async (dimensionVal: string = selectedDimension) => {
      ...
      setIsLoading(true);
      toast.info("در حال دریافت آخرین داده‌ها از Google Analytics 4...");
      ...
      try {
        ...
        toast.success("داده‌های Google Analytics 4 به‌روزرسانی شد");
        return result;
      } catch (error) {
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <SelectTrigger className="w-[150px] h-9 text-xs bg-white dark:bg-brand-darker border-gray-200 dark:border-brand-dark focus:ring-1 focus:ring-offset-0 rounded-xl mr-2">
                <SelectValue placeholder="انتخاب dimension" />
              </SelectTrigger>
              <SelectContent className="dark:text-white text-xs dark:bg-brand-darker dark:border-brand-dark">
                <SelectItem value="general">عمومی</SelectItem>
                <SelectItem value="landings">صفحات ورود</SelectItem>
                <SelectItem value="pages">صفحات</SelectItem>
                <SelectItem value="channels">کانال‌ها</SelectItem>
                <SelectItem value="country">کشور</SelectItem>
                <SelectItem value="city">شهر</SelectItem>
                <SelectItem value="device">دستگاه</SelectItem>
              </SelectContent>
            </Select>
            ...
            >
              <SelectTrigger className="w-[110px] h-9 text-xs bg-white dark:bg-brand-darker border-gray-200 dark:border-brand-dark focus:ring-1 focus:ring-offset-0 rounded-xl">
                <SelectValue placeholder="ردیف‌ها" />
              </SelectTrigger>
              <SelectContent className="dark:text-white text-xs dark:bg-brand-darker dark:border-brand-dark">
