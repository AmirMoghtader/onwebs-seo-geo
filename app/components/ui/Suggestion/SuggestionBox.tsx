    ...
    try {
      ...
      if (error) {
        ...
        if (error.message?.includes("RATE_LIMIT")) {
          toast.error("پیشنهادها را خیلی سریع ارسال می‌کنید — کمی آهسته‌تر.");
        } else {
          toast.error("ارسال پیشنهاد شما ناموفق بود. لطفاً دوباره تلاش کنید.");
        }
        return;
      }
      ...
      <header className="flex items-center justify-between p-6 border-b border-gray-100 dark:border-white/5 bg-gray-50/50 dark:bg-white/[0.02]">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            >
              ایده‌ها، باگ‌ها، درخواست‌ها — همه به دست تیم می‌رسد
            </Text>
          </div>
        </div>
        <ActionIcon
        ...
        <AnimatePresence mode="wait">
          {sent ? (
            ...
            >
              ...
              >
                پیشنهاد شما ارسال شد. هر زمان خواستید می‌توانید پیشنهاد دیگری بفرستید.
              </Text>
            ...
            >
              ...
              <div className="space-y-1.5">
                ...
                <Textarea
                  ...
                  placeholder="چه چیزی بسازیم، رفع کنیم یا بهبود دهیم؟"
