...
const CrawlerType = () => {
  ...
  const toggleJavascriptRendering = async () => {
    ...
    try {
      ...
      triggerRefresh();
      toast.success("وضعیت رندر Javascript با موفقیت تغییر کرد");
    } catch (error) {
      console.error("Failed to toggle javascript rendering:", error);
      setJavascriptRendering(!newValue);
      toast.error("تغییر وضعیت رندر Javascript ناموفق بود");
    }
  };
  ...
  const togglePsiCrawl = async () => {
    ...
    try {
      ...
      if (details.apiKey) {
        ...
        toast.success("وضعیت Page Speed Insights با موفقیت تغییر کرد");
      }
    } catch (error) {
    ...
    <div className="relative">
      ...
      >
        <button
          ...
          aria-label="باز کردن تنظیمات Crawler"
        >
          ...
          >
            ...
            <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-900 rounded-md mb-3">
              ...
              <label className="relative inline-flex items-center cursor-pointer">
                <input
                  ...
                  aria-label="تغییر وضعیت رندر Javascript"
                />
              ...
              <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-900 rounded-md">
                ...
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
                    ...
                    className="sr-only peer"
                    aria-label="تغییر وضعیت کراول PageSpeed Insights"
                  />
                  <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
                </label>
              </div>
            ...
            <div className="mt-4 flex justify-end">
              <button
                ...
                aria-label="بستن و ذخیره تنظیمات"
              >
                بستن
              </button>
            </div>
