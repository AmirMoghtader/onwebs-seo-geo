...
const OllamaSelect: React.FC<OllamaSelectProps> = ({ closeOllama }) => {
  ...
  const handleModelSelection = async (selectedModel: string) => {
    try {
      ...
      toast.error("ذخیره مدل ناموفق بود");
    }
  };
    ...
    <section className="w-full h-full pb-3 overflow-hidden">
      <div className="p-4">
        <h2 className="font-semibold text-sm dark:text-white">
          برای تجربه بهتر، لازم است Ollama را دانلود کنید.
        </h2>
        ...
        <ol className="text-sm mt-2 list-decimal list-inside dark:text-white">
          ...
          <li>
            انتخاب مدل: مدل AI مناسب نیاز خود را انتخاب کنید.
          </li>
          <li>
            دانلود و نصب: دستورالعمل‌های نصب ارائه‌شده را دنبال کنید.
          </li>
          <li>پس از نصب، می‌توانید مدل را در پایین انتخاب کنید.</li>
          <li>برنامه را دوباره اجرا کنید.</li>
        </ol>
      </div>
      <div className="p-2 px-4">
        <Select
          label="مدل AI در Ollama"
