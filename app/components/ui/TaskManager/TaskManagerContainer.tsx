    ...
    <section className="h-[calc(100vh-9rem)] overflow-hidden flex justify-center">
      ...
      <div className="grid m-auto gap-4 lg:gap-4 grid-cols-3 px-7  w-full max-w-[80rem] overflow-hidden rounded-xl  mx-auto   place-items-center">
        <section className="w-full max-w-[380px] h-[calc(100vh-20rem)] dark:border-brand-dark  bg-white dark:bg-brand-darker rounded-xl mb-10 overflow-hidden my-auto shadow border">
          <div className="flex items-center border-b dark:border-b-brand-dark justify-between px-5 py-3 font-semibold">
            <div className="flex items-center space-x-2">
              <h1 className="text-xl dark:text-white">انجام‌نشده</h1>
        ...
        <section className="w-full max-w-[380px] h-[calc(100vh-20rem)] dark:border-brand-dark  bg-white dark:bg-brand-darker rounded-xl mb-10 overflow-hidden my-auto shadow border">
          <div className="flex items-center border-b dark:border-b-brand-dark justify-between px-5 py-3 font-semibold">
            <div className="flex items-center space-x-2">
              <h1 className="text-xl dark:text-white">در حال انجام</h1>
        ...
        <section className="w-full max-w-[380px] h-[calc(100vh-20rem)] dark:border-brand-dark  bg-white dark:bg-brand-darker rounded-xl mb-10 overflow-hidden my-auto shadow border">
          <div className="flex items-center border-b dark:border-b-brand-dark justify-between px-5 py-3 font-semibold">
            <div className="flex items-center space-x-2">
              <h1 className="text-xl dark:text-white">انجام‌شده</h1>
