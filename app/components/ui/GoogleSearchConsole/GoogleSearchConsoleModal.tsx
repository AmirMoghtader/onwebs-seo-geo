    ...
    if (validateForm()) {
      ...
      try {
        invoke("set_google_search_console_credentials", {
          ...
          toast.success("اطلاعات ورود با موفقیت ذخیره شد");
          close();
        });
      } catch (error) {
        console.error("Failed to save credentials:", error);
        toast.error("ذخیره اطلاعات ورود ناموفق بود");
      }
    }
  };
    ...
    <section>
      <div className="max-w-md mx-auto -mt-3 p-2 px-3 pb-5 bg-white dark:bg-brand-darker dark:text-white rounded-lg text-xs">
        <div className="flex items-center space-x-2">
          <h2 className="text-lg font-semibold mb-5 ml-1">وارد کردن اطلاعات ورود</h2>
          <span
            onClick={() =>
        ...
        <form onSubmit={handleSubmit} className="dark:bg-brand-darker">
          <div className="mb-4 relative">
            ...
            <input
              ...
              placeholder="Project ID را وارد کنید"
            />
            {errors.projectId && (
          ...
          <div className="mb-4 mt-4">
            ...
            >
              <option value="">یک Property Type انتخاب کنید</option>
          ...
          <div className="mb-6">
            ...
            >
              <option value="">یک بازه انتخاب کنید</option>
              {durations.map((range) => (
            ...
            <div className="mb-4 mt-2">
              ...
              >
                <option value="">تعداد ردیف‌ها را انتخاب کنید</option>
                {rows.map((rows) => (
