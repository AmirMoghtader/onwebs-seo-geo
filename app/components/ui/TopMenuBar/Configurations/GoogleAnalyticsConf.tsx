  ...
  return (
    <Card className="w-full mx-auto border-0 shadow-none bg-transparent">
      <CardHeader className="px-0 pt-0">
        ...
        <CardDescription className="dark:text-gray-400">شناسه GA4 Measurement ID شما که برای ردیابی و یکپارچه‌سازی متریک‌ها استفاده می‌شود.</CardDescription>
      </CardHeader>
