  ...
  return (
    <Card className="w-full mx-auto border-0 shadow-none bg-transparent">
      <CardHeader className="px-0 pt-0">
        ...
        <CardDescription className="dark:text-gray-400">API key امن شما که برای دریافت داده‌های PageSpeed Insights استفاده می‌شود.</CardDescription>
      </CardHeader>
