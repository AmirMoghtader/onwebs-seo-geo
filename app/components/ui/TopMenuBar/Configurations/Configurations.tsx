    ...
    <div className="flex flex-col w-full bg-white dark:bg-[#0f0f0f] rounded-2xl overflow-hidden border border-gray-100 dark:border-white/5">
      ...
      <header className="flex items-center justify-between p-6 border-b border-gray-100 dark:border-white/5 bg-gray-50/50 dark:bg-white/[0.02]">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <Text fw={800} size="lg" className="text-gray-900 dark:text-white tracking-tight">تنظیمات اتصال</Text>
            <Text size="xs" className="text-gray-500 dark:text-gray-400 font-medium">یکپارچه‌سازی‌های API خارجی خود را مدیریت کنید</Text>
          </div>
        </div>
      ...
      <div className="px-6 pb-6 pt-2 flex justify-between items-center">
        ...
        <Text size="xs" className="text-gray-400 dark:text-gray-600 font-mono italic opacity-60">Onwebs SEO & GEO v{localVersion}</Text>
      </div>
    </div>
  );
};
