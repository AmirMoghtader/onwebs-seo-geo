        ...
        <section>
          <Group justify="space-between" mb={8} wrap="nowrap">
            <div className="flex items-center gap-2">
              ...
              <Text fw={700} size="md" className="dark:text-gray-100">مدل فعال هوش مصنوعی</Text>
            </div>
          </Group>
          ...
          <TextInput
            placeholder="هیچ مدلی شناسایی نشد"
            value={aiModel}
            readOnly
            styles={{
              input: {
          ...
          <section>
            <Group justify="space-between" mb={8} wrap="nowrap">
              <div className="flex items-center gap-2">
                ...
                <Text fw={700} size="md" className="dark:text-gray-100">نمونه Ollama</Text>
              </div>
            </Group>
            <Text size="xs" className="text-gray-500 dark:text-gray-400 mb-4">
