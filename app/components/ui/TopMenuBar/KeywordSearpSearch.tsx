...
export default function KeywordSearch() {
  ...
  const handleSerpHeadings = async () => {
    ...
    try {
      ...
      toast.error("دریافت heading‌های SERP ناموفق بود. لطفاً دوباره تلاش کنید.");
    } finally {
      setIsLoading(false);
    }
  };
  ...
  const handleFetchSuggestions = async () => {
    ...
    try {
      ...
      toast.error("دریافت پیشنهادها ناموفق بود. لطفاً دوباره تلاش کنید.");
    } finally {
    ...
    >
      ...
      <Tabs defaultValue="headings">
        <Tabs.List className="ml-2 mr-4 -mt-2" justify="center" grow>
          <Tabs.Tab value="headings">Headingها</Tabs.Tab>
          <Tabs.Tab value="suggestions">پیشنهادها</Tabs.Tab>
        </Tabs.List>
        ...
        <Tabs.Panel value="headings">
          <div className="mb-2 flex w-full items-center pr-4 mt-2">
            <Creatable<KeywordOption>
              ...
              // react-select generates sequential element ids; without a fixed
              // instanceId the server and client sequences differ and React
              // reports a hydration attribute mismatch on every load.
              instanceId="serp-keyword-select"
              placeholder="جستجوی Google..."
            ...
            >
              ...
              <SelectContent className="z-[999999999] text-xs border w-10">
                ...
                <SelectItem value="nl">هلندی</SelectItem>
                ...
                <SelectItem value="pt">پرتغالی</SelectItem>
        ...
        <Tabs.Panel value="suggestions">
          <div className="mb-2 flex w-full items-center pr-4 mt-2">
            <Creatable<KeywordOption>
              ...
              instanceId="serp-suggestion-select"
              placeholder="یک Keyword وارد کنید..."
              className="basic-multi-select border-0 border-brand-dark w-11/12 text-xs pl-2 dark:bg-brand-darker dark:text-white"
              classNamePrefix="select"
              formatCreateLabel={(inputValue) => `Add "${inputValue}"`}
