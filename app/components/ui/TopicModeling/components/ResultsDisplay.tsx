...
export default function ResultsDisplay({ results }: ResultsDisplayProps) {
  ...
  return (
    <div className="space-y-4">
      <div>
        <h3 className="text-lg font-semibold">کلمات کلیدی</h3>
      ...
      <div>
        <h3 className="text-lg font-semibold">موضوعات</h3>
        <ul className="list-disc pl-5">
      ...
      <Button onClick={handleDownloadPDF}>دانلود نتایج به‌صورت PDF</Button>
    </div>
  );
}
