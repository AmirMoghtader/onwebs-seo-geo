...
export default function GA4ConnectionWizard({
  ...
  const fetchProperties = async (token: string) => {
    try {
      ...
      if (props && props.length > 0) {
        ...
        toast.error("هیچ property‌ای در GA4 پیدا نشد");
      }
    } catch (error) {
  ...
  const handleFinalize = async () => {
    ...
    try {
      ...
      toast.success(
        "Google Analytics با موفقیت متصل شد! لطفاً جدول را تازه‌سازی کنید.",
      );
      onComplete();
    } catch (error) {
    ...
    <div className="flex flex-col min-h-[500px] w-full max-w-lg mx-auto overflow-hidden bg-white dark:bg-brand-darker rounded-2xl shadow-2xl border border-gray-100 dark:border-brand-dark">
      ...
      <div className="p-6 border-b border-gray-100 dark:border-brand-dark flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-lg font-bold dark:text-white">اتصال به GA4</h2>
              ...
              <div className="flex-1 flex flex-col items-start justify-center space-y-4">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400 leading-relaxed max-w-xs mx-auto">
                    Google Analytics 4 را متصل کنید تا sessionها، نرخ پرش و تعامل کاربران را رصد کنید.
                  </p>
                </div>
              ...
              <div className="flex-1 space-y-3">
                <div className="space-y-1">
                  ...
                  <p className="text-[10px] text-gray-500 dark:text-gray-400">
                    جزئیات Google Cloud Project خود را برای GA4 وارد کنید.
                  </p>
                </div>
                <button
                  type="button"
              ...
              <div className="flex-1 flex flex-col items-start justify-center space-y-6">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400 max-w-xs mx-auto">
                    اکنون یک پنجره امن ورود Google باز می‌شود.
                  </p>
                </div>
                <Button
              ...
              <div className="space-y-2 pt-4">
                <div className="p-2 bg-amber-50 dark:bg-amber-900/20 border border-amber-100 dark:border-amber-900/30 rounded-lg">
                  <p className="text-[9px] text-amber-800 dark:text-amber-200 flex items-center gap-1.5 justify-center">
                    ...
                    اگر popup باز نشد، مسدود بودن popupها را بررسی کنید.
                  </p>
                </div>
              </div>
            </motion.div>
          ...
          {step === 4 && (
            ...
            >
              <div className="flex-1 space-y-4">
                <div className="space-y-1">
                  <h3 className="text-md font-bold dark:text-white">
                    انتخاب Property در GA4
                  </h3>
                  <p className="text-[10px] text-gray-500 dark:text-gray-400">
                    Property مورد نظر در GA4 را برای رصد انتخاب کنید.
                  </p>
                </div>
