      ...
      <header className="flex items-center justify-between p-6 border-b border-gray-100 dark:border-white/5 bg-gray-50/50 dark:bg-white/[0.02]">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            >
              درباره Onwebs SEO & GEO
            </Text>
            <Text
              size="xs"
              className="text-gray-500 dark:text-gray-400 font-medium"
            >
              جزئیات برنامه و به‌روزرسانی‌ها
            </Text>
          </div>
        </div>
        <ActionIcon
      ...
      <div className="p-8 space-y-8">
              ...
              >
                <Group justify="space-between" wrap="nowrap">
                  <Group gap="sm" wrap="nowrap">
                    ...
                    <Text size="xs" fw={700}>
                      نسخه جدید Onwebs SEO & GEO آماده دریافت است!
                    </Text>
                  </Group>
                  <Button
                    variant="filled"
        ...
        >
          ...
          <section className="space-y-4 relative z-10">
            ...
            >
              «این نرم‌افزار آزمایشی است؛ انتظار بروز اشکال را داشته باشید. کار به‌عنوان یک پروژه شخصی آغاز شد و به یک جعبه‌ابزار کاربردی SEO/بازاریابی تبدیل شده است. هدف، بهبود مداوم آن و افزودن قابلیت‌های بیشتر است.»
            </Text>
            ...
            >
              بازخورد شما چیزی است که این پروژه را زنده نگه می‌دارد. ممنون که بخشی از این مسیر هستید.
            </Text>
          </section>
        </Paper>
        ...
        <footer className="flex justify-between items-center px-2">
          ...
          >
            Onwebs SEO & GEO © {new Date().getFullYear()}
          </Text>
        </footer>
      </div>
    </motion.div>
