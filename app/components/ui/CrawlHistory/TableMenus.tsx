    ...
    <ContextMenu>
      ...
      <ContextMenuContent className="w-40">
        <ContextMenuItem onClick={() => handleCopy(data?.url)}>
          <FiClipboard className="mr-2" /> کپی
        </ContextMenuItem>
        ...
        <ContextMenuItem onClick={() => crawl(data?.url)}>
          <FiRefreshCw className="mr-2" /> کراول مجدد
        </ContextMenuItem>
        <ContextMenuSub>
          <ContextMenuSubTrigger>
            <FiCheckSquare className="mr-2" /> بررسی ایندکس
          </ContextMenuSubTrigger>
        ...
        <ContextMenuSub>
          <ContextMenuSubTrigger>
            <FiCheckSquare className="mr-2" /> اعتبارسنجی
          </ContextMenuSubTrigger>
          <ContextMenuSubContent className="w-48">
            <ContextMenuItem>
              <FiSave className="mr-2" /> ذخیره صفحه به‌عنوان...
              <ContextMenuShortcut>⇧⌘S</ContextMenuShortcut>
            </ContextMenuItem>
            <ContextMenuItem>
              <FiPlusSquare className="mr-2" /> ساخت میان‌بر...
            </ContextMenuItem>
            <ContextMenuItem>
              <FiEdit className="mr-2" /> نام‌گذاری پنجره...
            </ContextMenuItem>
            <ContextMenuSeparator />
            <ContextMenuItem>
              <FiTool className="mr-2" /> ابزار توسعه‌دهنده
            </ContextMenuItem>
          </ContextMenuSubContent>
        </ContextMenuSub>
        <ContextMenuSub>
          <ContextMenuSubTrigger>
            <FiClock className="mr-2" /> تاریخچه
          </ContextMenuSubTrigger>
          <ContextMenuSubContent className="w-48">
            <ContextMenuItem>
              <FiSave className="mr-2" /> ذخیره صفحه به‌عنوان...
