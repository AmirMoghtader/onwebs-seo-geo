    ...
    <section className="flex-wrap min-h-[calc(96rem - 2.5rem)] h-[calc(100vh-2.5rem)] space-y-1 dark:bg-slate-900 dark:text-white px-1 py-1 relative">
      <div className="px-2 py-1.5 grid gap-5 dark:text-white">
        <div className="grid gap-3">
          <div className="flex flex-row-reverse items-center justify-between">
            <div className="flex flex-row-reverse items-center space-x-2 space-x-reverse">
              ...
              <span className="font-semibold pt-1">زمان مطالعه</span>
            </div>
            <span>
          ...
          <div className="flex flex-row-reverse items-center justify-between">
            <div className="flex flex-row-reverse items-center space-x-2 space-x-reverse -mt-2">
              <FiType className="text-sky-dark mt-[5px]" size={18} />
              <span className="font-semibold mt-2">تعداد کلمات</span>
            </div>
          ...
          <div className="flex flex-row-reverse items-center justify-between">
            <div className="flex flex-row-reverse items-center space-x-2 space-x-reverse">
              ...
              <span className="font-semibold">سطح خوانایی</span>
            </div>
            <span>
        ...
        <div className="flex flex-row-reverse items-center justify-between -mt-1">
          <div className="flex flex-row-reverse items-center space-x-2 space-x-reverse -mt-3">
            <FiSliders className="text-sky-dark mt-1" size={18} />
            <span className="font-semibold mt-2">نسبت متن</span>
          </div>
          <span>
        ...
        <div className="flex flex-row-reverse items-center justify-between -mt-2">
          <div className="flex flex-row-reverse items-center space-x-2 space-x-reverse">
            ...
            <span className="font-semibold">رسانه</span>
          </div>
          <span>
            {keywords.length > 0 &&
              video &&
        ...
        <div className="flex items-start justify-start flex-col mt-4 h-full ">
          <div className="flex items-start space-x-2">
            <div className="flex flex-col w-full justify-center">
              <div className="flex flex-row-reverse items-center justify-end mb-3 -mt-6">
                <FiBookOpen className="text-sky-dark mt-1" size={18} />
                <span className="font-semibold block mr-2 pt-0.5">
                  کلمات کلیدی برتر
                </span>
              </div>
