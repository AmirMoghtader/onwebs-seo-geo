export const changelogData = [
  {
    ...
    changes: [
      ...
      "Global: Version Check Modal with Current and Previous Releases Changelog ",
      ...
      "Deep Crawler: Context menus on URLS/Links",
      ...
      "Server Logs: PDF Report Implementation ( **Experimental** )",
    ],
  },
  {
    version: "0.3.9",
  ...
  },
  {
    ...
    type: "feature",
    changes: [
      "Global: Better context to Onwebs AI",
