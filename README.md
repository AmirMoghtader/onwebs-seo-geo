...
No telemetry, no analytics, no phone-home. The community chat, suggestion box and remote update checks present in upstream were **removed** in this fork after a security audit. Crawl data lives in a local database on your machine. See [SECURITY.md](SECURITY.md).
